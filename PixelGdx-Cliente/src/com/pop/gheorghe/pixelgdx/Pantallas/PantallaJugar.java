...
//				System.out.println("Quiero mandar onda : " +v.tiempo);
	...
	public void update( float delta ) {
		...
		// TODO: SERVER Conseguir informaciï¿½n del jugador 2 en el server
		if ( game.isServer ) {
...
//			gameCam.position.x = Math.round( (gamePort.getScreenWidth()/PixelGdx.PPM)/2 * 100f)/100f; // Esto soluciona el problema de las lï¿½neas al renderizar
...
//			gameCam.position.x = Math.round( jugador.b2body.getPosition().x * 100f)/100f ; // Esto soluciona el problema de las lï¿½neas al renderizar
